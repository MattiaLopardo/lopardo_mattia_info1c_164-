...
def films_genres_afficher(id_personne_sel):
    ...
    if request.method == "GET":
        try:
            ...
            raise ExceptionPersonnesCategoriesAfficher(f"fichier : {Path(__file__).name}  ;  {films_genres_afficher.__name__} ;"
                                               f"{Exception_personnes_categories_afficher}")

    print("films_genres_afficher  ", data_categories_personnes_afficher)
    # Envoie la page "HTML" au serveur.
    return render_template("films_genres/films_genres_afficher.html", data=data_categories_personnes_afficher)
...
def edit_genre_film_selected():
    if request.method == "GET":
        try:
            ...
            print("dans edit_genre_film_selected ---> data_categories_all", data_categories_all)
            ...
            data_categorie_personne_selected, data_categories_personnes_non_attribues, data_categories_personnes_attribues = \
                genres_films_afficher_data(valeur_id_personne_selected_dictionnaire)
...
def update_genre_film_selected():
    ...
    return redirect(url_for('films_genres_afficher', id_personne_sel=id_personne_selected))
...
def genres_films_afficher_data(valeur_id_personne_selected_dict):
    ...
    try:
        ...
        with DBconnection() as mc_afficher:
            ...
            print("genres_films_afficher_data ----> data_categories_personnes_non_attribues ", data_categories_personnes_non_attribues,
                  " Type : ",
                  type(data_categories_personnes_non_attribues))
