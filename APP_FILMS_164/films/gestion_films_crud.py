...
from APP_FILMS_164.films.gestion_films_wtf_forms import FormUpdatePersonne, FormAddPersonne, FormDeletePersonne
...
def film_add_wtf():
    ...
    if request.method == "POST":
        try:
            if form_add_personne.validate_on_submit():
                ...
                return redirect(url_for('films_genres_afficher', id_personne_sel=0))
    ...
    return render_template("films/film_add_wtf.html", form_add_personne=form_add_personne)
...
def film_update_wtf():
    ...
    try:
        ...
        if form_update_personne.validate_on_submit():
            ...
            return redirect(url_for('films_genres_afficher', id_personne_sel=id_personne_update))
    ...
    return render_template("films/film_update_wtf.html", form_update_personne=form_update_personne)
