"""
    ...
    Gestions des "routes" FLASK et des données pour les categories.
"""
import sys
...
from APP_EasyVista_164.erreurs.msg_erreurs import *
from APP_EasyVista_164.essais_wtf_forms.wtf_forms_demo_select import DemoFormSelectWTF
    ...
    try:
        ...
        if request.method == "GET":
            with DBconnection() as mc_afficher:
                strsql_categorie_afficher = """SELECT id_genre, intitule_genre FROM t_genre ORDER BY id_genre ASC"""
